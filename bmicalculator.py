...
# GUI layout
tk.Label(root, text="Enter your weight (kg):").pack(pady=8)
weight_entry = tk.Entry(root)
weight_entry.pack(pady=8)
tk.Label(root, text="Enter your height (cm):").pack(pady=8)
height_entry = tk.Entry(root)
height_entry.pack(pady=8)
bmi_result = tk.StringVar()
tk.Label(root, textvariable=bmi_result).pack(pady=13)
classification_label = tk.Label(root, text="")
classification_label.pack(pady=8)
